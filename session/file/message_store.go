...
type MessageStore struct {
	dir        string
	mu         sync.RWMutex
	summarizer hwcloud.Summarizer // nil = compaction is a no-op
...
func (m *MessageStore) readAllLocked(ctx context.Context, sessionID string) ([]hwcloud.Message, error) {
...
func (m *MessageStore) writeCompressed(sessionID string, cc *hwcloud.CompressedContext) error {
...
func (m *MessageStore) readCompressed(sessionID string) (*hwcloud.CompressedContext, error) {

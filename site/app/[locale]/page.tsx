...
const REPO = "https://github.com/Cloud-Developer-Department/hwcloud";
    ...
    <>
      ...
      <section className="border-y border-border bg-surface">
        <div className="mx-auto max-w-7xl px-6 py-16">
          ...
          {/* IAC MCP Server 入口 — 与架构同处深底 section，平级产品入口 */}
          <div className="mt-10 border-t border-border pt-6">
            <Link
              href={`/${locale}/docs/iac-server`}
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        ...
        <CodeBlock label="bash">{`go build -o hwcloud ./cmd/cli/
...
# REST mode (HTTP + SSE)
./hwcloud serve --port 8080`}</CodeBlock>

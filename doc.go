// Package hwcloud provides a fully pluggable AI Agent, modeled after
...
//	    hwcloud.WithModel(openai.New("gpt-4o")),
//	    hwcloud.WithSystemPrompts("You are a helpful assistant."),
//	    hwcloud.WithTools(myTool1, myTool2),
//	)
//	result, err := agent.Run(ctx, session, hwcloud.UserMessage("hello"))
//
